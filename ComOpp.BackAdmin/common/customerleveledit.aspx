<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerleveledit.aspx.cs"
    Inherits="ComOpp.BackAdmin.common.customerleveledit" %>
...
<div>
    ...
    <ul class="tabs_box_one">
        ...
        <li>
            <label class="llabel">
                降级天数：</label><input runat="server" type="text" id="txtDrtday" name="txtDrtday"
                    value="0" class="traceInp textbox Validform_error" datatype="n" nullmsg="降级天数"
                    errormsg="请输入降级天数" />
            <span>（填写0表示不降级）</span></li>
        <li>
            <label class="llabel">
                报警天数：</label><input runat="server" type="text" id="txtAlarmday" name="txtAlarmday"
                    class="traceInp textbox Validform_error" datatype="n" nullmsg="报警天数" errormsg="请输入报警天数" /></li>
    </ul>

...
<head>
    ...
    <title>客户等级管理-红旭集团商机管理系统V1.0</title>
...
<body>
    <div class="Tab">
        <a href="basesetting.aspx">基础设置</a> <a href="customerlevelmg.aspx" class="selected">
            客户等级</a> <a href="infotypemg.aspx">信息类型</a> <a href="infosourcemg.aspx">信息来源</a>
        <a href="connectwaymg.aspx">追踪方式</a> <a href="giveupcausemg.aspx">放弃原因</a> <a href="paymentwaymg.aspx">
            支付方式</a> <a href="ibuytimemg.aspx">拟购时间</a> <a href="tracktagmg.aspx">线索标签</a>
        <a href="archivesetting.aspx">转出设置</a>
    </div>
    <div>

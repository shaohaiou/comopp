<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ibuytimemg.aspx.cs" Inherits="ComOpp.BackAdmin.common.ibuytimemg" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>拟购时间管理-红旭集团销售客户管理系统V1.0</title>
...
<body>
    <div class="Tab">
        ...
        <a href="ibuytimemg.aspx?corpid=<%=GetInt("corpid") %>" class="selected">拟购时间</a> <a href="tracktagmg.aspx?corpid=<%=GetInt("corpid") %>">线索标签</a> <a href="archivesetting.aspx?corpid=<%=GetInt("corpid") %>">
            转出设置</a>
    </div>
    <div>
    ...
    <script type="text/javascript">
        ...
        Core.Easyui.Action = function (method, o) {
            ...
            switch (method) {
                case 'add':
                    dialog('580', '300', '添加', "ibuytimeedit.aspx?from=<%=CurrentUrl %>&corpid=" + corpid + "&r=" + Math.random());
                    break;
                case 'edit':
                    ...
                    dialog('580', '300', '编辑', "ibuytimeedit.aspx?from=<%=CurrentUrl %>&id=" + rows[0].id + "&r=" + Math.random());
                    break;
                case 'remove':
                    var ids = []
        ...
        $(document).ready(function () {
            Core.Easyui.get("/common/ibuytimelist.aspx?corpid=" + corpid);
        })
    </script>
    <script type="text/javascript">
        $(document).ready(function () {

...
<head>
    ...
    <title>信息类型管理-红旭集团销售客户管理系统V1.0</title>
...
<body>
    <div class="Tab">
        <a href="basesetting.aspx">基础设置</a> <a href="customerlevelmg.aspx?corpid=<%=GetInt("corpid") %>">客户等级</a> <a href="infotypemg.aspx?corpid=<%=GetInt("corpid") %>"
            class="selected">信息类型</a> <a href="infosourcemg.aspx?corpid=<%=GetInt("corpid") %>">信息来源</a> <a href="connectwaymg.aspx?corpid=<%=GetInt("corpid") %>">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="infosourcemg.aspx.cs" Inherits="ComOpp.BackAdmin.common.infosourcemg" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        Core.Easyui.Action = function (method, o) {
            ...
            switch (method) {
                case 'add':
                    dialog('580', '300', '添加', "infosourceedit.aspx?from=<%=CurrentUrl %>&corpid=" + corpid + "&r=" + Math.random());
                    break;
                case 'edit':
                    ...
                    dialog('580', '300', '编辑', "infosourceedit.aspx?from=<%=CurrentUrl %>&id=" + rows[0].id + "&r=" + Math.random());
                    break;
                case 'remove':
                    var ids = []
        ...
        $(document).ready(function () {
            Core.Easyui.get("/common/infosourcelist.aspx?corpid=" + corpid);
        })
    </script>
    <script type="text/javascript">
        $(document).ready(function () {

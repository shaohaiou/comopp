    ...
    Validform.util = {
            ...
            curform.find("[datatype]").each(function () {
                if (tiptype == 2) {
                    if ($(this).parent().next().find(".Validform_checktip").length == 0) {
                        $(this).parent().next().append("<span class='Validform_checktip'><i></i></span>");
                    }
                } else if (tiptype == 3 || tiptype == 4) {
                    if ($(this).siblings(".Validform_checktip").length == 0) {
                        $(this).parent().append("<span class='Validform_checktip'><i></i></span>");
                    }
                }
            })
        ...
        showmsg: function (msg, type, o, triggered) {
            ...
            */
            ...
            if (type == 2 && o.obj) {
                o.obj.parent().next().find(".Validform_checktip").html('<i></i>' + msg);

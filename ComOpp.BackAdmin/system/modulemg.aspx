<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modulemg.aspx.cs" Inherits="ComOpp.BackAdmin.system.modulemg" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>模块管理-红旭集团销售客户管理系统V1.0</title>
...
<body>
    <div class="Tab">
        ...
        <a href="modulemg.aspx" class="selected">模块管理</a>
    ...
    <script type="text/javascript">
        ...
        { field: 'parentname', title: '上级模块', width: 100, align: 'center' },
        ...
        $(document).ready(function () {
            Core.Easyui.get("/system/modulelist.aspx");
        })
    </script>
    <script type="text/javascript">
        $(document).ready(function () {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="talkedit.aspx.cs" ValidateRequest="false" Inherits="ComOpp.BackAdmin.support.talkedit" %>
...
<body>
    ...
    <div>
        ...
        <ul class="tabs_box_one">
            ...
            <li>
                <label class="llabel">
                    标签：</label><input runat="server" id="txtTag" value="" class="traceInp textbox" style="width: 250px !important"
                        type="text" />
                <span class="tag">价格</span> <span class="tag">竞品</span> <span class="tag">参数</span>
                <span class="tag">交通</span> <span class="tag">售后</span> <span class="tag">品牌</span>
                <span class="tag">保险</span> <span class="tag">信贷</span> <span class="tag">上牌</span>
            </li>
            <li>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="editor" style="width:800px;height:260px;"><%=CurrentTalk == null ? "" : CurrentTalk.Content%></script>
                        </td>
                    </tr>
                </table>
            </li>
...
<script type="text/javascript">
    ...
    $(function () {
        $("span.tag").click(function () {
            var o = $("#txtTag");
            try {
                var tag = $.trim(o.val()).replace(/(^,*)|(,*$)/g, '');
                tag = tag.split(',');
                if ($.inArray($(this).text(), tag) == -1) {
                    tag.push($(this).text());
                }
                o.val(tag.join(',').replace(/(^,*)|(,*$)/g, ''))
            } catch (e) { }
        })
    })
</script>

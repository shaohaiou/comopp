...
{
    public partial class potentialmg : AdminBase
    {
        protected override void Check()
        {
            ...
            if (!Admin.Administrator && Admin.UserRole != UserRoleType.系统管理员 && !CheckGroupPower(Admin.GroupPower, "潜客数据库"))
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.Redirect("potentialmg.aspx?corpid=" + ddlCorporationSearch.SelectedValue);
        }
    }
}
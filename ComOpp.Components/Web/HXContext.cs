    ...
    public class HXContext
    {
        ...
        public CorporationInfo CurrentCorporation
        {
            get
            {
                ...
                {
                    if (AdminUser != null && !AdminUser.Administrator)
                    {
                        return Corporations.Instance.GetModel(AdminUser.CorporationID, true);
                    }
                }
        ...
        private PowerGroupInfo _currentpowergroup = null;
        public PowerGroupInfo CurrentPowerGroup
        {
            get
            {
                if (_currentpowergroup == null)
                {
                    if (AdminUser != null && !AdminUser.Administrator && AdminUser.UserRole != UserRoleType.系统管理员)
                    {
                        return PowerGroups.Instance.GetModel(AdminUser.PowerGroupID, true);
                    }
                }
                return _currentpowergroup;
            }
            set
            {
                _currentpowergroup = value;
            }
        }
        ...
        public UrlRuleType UrlRuleType
        {
            get
            {
                if (_urlRule == UrlRuleType.NoSet)
                    _urlRule = UrlRuleType.Default;
                return _urlRule;
            }
            set
            {

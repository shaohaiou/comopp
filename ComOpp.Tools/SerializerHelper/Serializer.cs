...
namespace ComOpp.Tools
{
    ...
    public class Serializer
    {
        ...
        public static string SerializeJson(object o)
        {
            ...
            return Newtonsoft.Json.JsonConvert.SerializeObject(o,Newtonsoft.Json.Formatting.None, timeFormat);
        }
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public static string SerializeSystemJson(object o)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static T DeserializeSystemJson<T>(string s)
        {
